...
| 项目目录 | 类型 |
|---|---|
| `D:\Users\turnin\IdeaProjects\korepos\` | Flutter 终端主端 |
| `D:\Users\turnin\IdeaProjects\korepos-refund\` | Flutter 退款子端 |
| `D:\Users\turnin\IdeaProjects\kpay-pos-business-app-bff\` | BFF 聚合层（Spring Cloud） |
| `D:\Users\turnin\IdeaProjects\kpay-pos-order-manage\` | 订单微服务（Spring Cloud） |
| `D:\Users\turnin\IdeaProjects\kpay-possystem-commodity\` | 商品中心 |
| `D:\Users\turnin\IdeaProjects\pos-store-operation-manage\` | 门店经营管理 |
| `D:\Users\turnin\IdeaProjects\kpay-pos-report\` | 报表 |
| `D:\Users\turnin\IdeaProjects\price-calc-sdk\` | Rust 算价 SDK |
| `D:\Users\turnin\IdeaProjects\pos-config-ts\` | 配置中心 |
...
打开 `D:\Users\turnin\IdeaProjects\kpay-pos-topology\CLAUDE.md`，读到 § 查找索引表。**不允许跳过这步直接 grep 项目源码**。
...
2. **不准**写到单个项目的 `docs/`
3. **不准**写到 `caseflow/` 里任何位置
4. **必须**写到 `D:\Users\turnin\IdeaProjects\kpay-pos-topology\` 下对应目录
...
- [ ] 文档是否落到了 `kpay-pos-topology/` 下，而不是 memory / 项目 docs / caseflow？
...
- 路由逻辑调整 → 更新本 SKILL.md § 路由逻辑 + `caseflow/docs/skill-flow.md`
